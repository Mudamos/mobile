import { allPass, pipe, prop, propEq } from "ramda";

import { CITYWIDE_SCOPE, STATEWIDE_SCOPE, includes, isBlank } from "../utils";

export const isNationalCause = (plip) =>
  allPass([
...
export const isStateNationalCause = (plip) =>
  allPass([
    pipe(prop("uf"), isBlank),
    propEq("scopeCoverage", STATEWIDE_SCOPE),
  ])(plip);

export const isCityNationalCause = (plip) =>
  allPass([
    pipe(prop("cityName"), isBlank),
