...
export default class ProfileWalletLayout extends Component {
          ...
          <ScrollView style={styles.full}>
            ...
            {revalidateProfileSignPlip && !hasError && (
              <View style={styles.revalidateContainer}>
                ...
                <Text style={[styles.text, styles.weNeed]}>
                  {locale.weNeedAnalyseYourProfileToSign}
                </Text>
                <Text style={[styles.text, styles.bold, styles.pressButton]}>
                  {locale.pressTheButtonToValidateYourWallet}
                </Text>
                <RoundedButton
  ...
  renderNavBar() {
    return <NavigationBar middleView={<HeaderLogo />} />;
  }
}
