...
import { CITYWIDE_SCOPE, STATEWIDE_SCOPE } from "../utils";
...
export const getIneligiblePlipReasonForScope = (scope) => (state) => {
  ...
  switch (scope) {
    case CITYWIDE_SCOPE:
      return config.ineligibleToSignCitywidePlipReason;
    case STATEWIDE_SCOPE:
      return config.ineligibleToSignStatewidePlipReason;
  }
};

export const privacyPolicyURL = compose(
