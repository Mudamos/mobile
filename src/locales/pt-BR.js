const translations = {
  ...
  confirmed: "Validado",
  confirmVoteSubtitle: "Um SMS será enviado ao seu celular para que seja validado o voto. Entre com seu número e no próximo passo digite o código que recebeu via SMS.",
  confirmVoteTitle: "Valide seu voto",
  confirmVoteCodeSubtitle: "Agora entre com o código que receberá via SMS e valide seu voto.",
  ...
  validate: "Validar",
  verify: "Verificar",
  voteAddressSubtitle: "De acordo com a Constituição Federal, você só pode assinar os projetos de iniciativa popular do mesmo município e estado de onde você é eleitor, ou seja, onde você vota. Agora, verifique se esses dados estão corretos.",
  ...
  errors: {
    ...
    noEmailDuringSignIn: "Para efetuar o login é necessário compartilhar algum email.",
