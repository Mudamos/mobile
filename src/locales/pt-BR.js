const translations = {
  ...
  actionSignerError: {
    ...
    "incomplete-profile":
      "Perfil incompleto. Use a app da Mudamos para completar seu perfil. Acesse no menu a opção 'Validar perfil'.",
    "invalid-wallet":
      "Sua assinatura é inválida. Use a app da Mudamos para atualizá-la. Acesse no menu a opção 'Validar perfil'.",
    "unknown-error": "Erro ao efetuar ação.",
    "user-not-logged-in":
      "Usuário não logado. Use a app da Mudamos para se logar.",
  },
  ...
  backToMainPageToSignAndShareNationalPlipOrFromYourRegion:
    "Volte para a página principal e veja projetos nacionais ou de sua localidade para assinar e compartilhar.",
  ...
  confirmed: "Validado",
  confirmVoteSubtitle:
    "Um SMS será enviado ao seu celular para que seja validado o voto. Entre com seu número e no próximo passo digite o código que recebeu via SMS.",
  confirmVoteTitle: "Valide seu voto",
  confirmVoteCodeSubtitle:
    "Agora entre com o código que receberá via SMS e valide seu voto.",
  confirmVoteCodeTitle: "Digite o código",
  createAPlInformation:
    "Com a tecnologia e comunidade Mudamos, seu projeto de lei de iniciativa popular ganha força. Aproveite!",
  cityFilterTitle: "Selecione a cidade",
  cityName: "Nome da cidade",
  cityWhereVote: "Município onde eu voto",
  clearSearch: "Limpar busca",
  clickOnIconAndShare: "Clique no ícone abaixo e compartilhe agora!",
  close: "Fechar",
  codeHasBeenSentToPhone:
    "Seu código de confirmação foi enviado por SMS para o número",
  codeSent: "Código enviado",
  conclude: "Concluído",
  concludeHeaderTitle: "Cadastro concluído!",
  concludeHeaderSubtitle:
    "Agora, você pode conhecer todas as propostas de melhorias para o país que foram enviadas para o Mudamos como projetos de lei de iniciativa popular. Comece agora mesmo a fazer parte dessa mobilização e participe da construção de leis no Brasil.",
  confirm: "Confirmar",
  ...
  helpPl: ({ plName, region }) =>
    `Você pode ajudar o projeto ${plName} divulgando para quem for de ${region}.`,
  identification: "Identificação",
  ifYouWannaProceedClickTheButtonBelow:
    "Se quiser prosseguir, clique no botão abaixo.",
  ...
  noProjectsYet:
    "No momento, não há projetos de lei para essa localidade, mas estamos recebendo propostas.",
  noSignedProjects: "Você não possui projetos assinados.",
  youShouldBeLoggedToSeeYourSignedProjects:
    "Você precisa está logado para ver seus projetos assinados.",
  noFavoriteProjects: "Você não possui projetos favoritos.",
  noProjectsMatch: "No momento, nenhum projeto foi encontrado.",
  youShouldBeLoggedToSeeYourFavoriteProjects:
    "Você precisa está logado para ver seus projetos favoritos.",
  ...
  pleaseSelectCity: "Selecione um município",
  pleaseSelectUf: "Selecione um estado",
  pressTheButtonToValidateYourWallet:
    "Clique no botão abaixo para validar sua carteira.",
  profileActive:
    "Seu perfil está ativo! Isso significa que suas informações estão corretas e sincronizadas ao Mudamos.",
  ...
  revalidationExplanation:
    "Desculpe, mas parece que alguma coisa no ato da sua assinatura não funcionou como o esperado. Por isso, precisamos revalidar o seu cadastro.",
  save: "Salvar",
  search: "buscar",
  searchPlipNotFound: ({ searchTitle }) =>
    `No momento, nenhum projeto foi encontrado com o termo "${searchTitle}".`,
  send: "Enviar",
  sendYourPL: "Proponha um PL!",
  securityMessage:
  ...
  shareMessage: ({ description, name, hashtag }) =>
    `${description}! Assine ${name} e construa um Brasil melhor. ${hashtag}`,
  showMe: "Me mostre",
  sign: "Assinar",
  signature: "Assinatura",
  signatures: "Assinaturas",
  signaturesAndGoal: ({ signatures, goal }) =>
    `Assinaturas: ${signatures} Meta: ${goal}`,
  signPlip: "Assinar Projeto de Lei",
  signPlipAtYourRegion: "Assine Projetos de seu Estado ou Município",
  signupSuccessModalText:
    "Seu celular foi validado e agora você já pode assinar projetos de lei de iniciativa popular.",
  signed: "Assinado",
  ...
  stateWhereVote: "Estado onde eu voto",
  "success!": "Sucesso!",
  takePhoto: "Tirar uma foto",
  thanksForFeedback: "Obrigado por compartilhar sua opinião com a gente.",
  tellAFriendMessages: {
    phr1:
      "Seu celular como arma de intervenção no cenário político brasileiro. Baixe agora e assine!",
    phr2:
      "Para você que acredita que existe uma luz no fim túnel. Mude a política, baixe agora e assine!",
    phr3:
      "Para fazer lei sem depender de deputados e senadores. Baixe agora e assine!",
  },
  ...
  tseSubmit: "Consultar",
  tseTutorial1:
    "Você será redirecionado para o site do Tribunal Superior Eleitoral (TSE).",
  tseTutorial2: "Uma vez no site, poderá buscar por seu título de eleitor.",
  tseTutorial3: "Preencha ambos os campos",
  tseTutorial4:
    "Preencha seu nome completo, exatamente igual ao título de eleitor.",
  tseTutorial5: "Agora, clique em",
  tseTutorial6:
    "Este passo ajuda o Tribunal Superior Eleitoral a evitar o acesso por programas automáticos.",
  tseTutorial7:
    "Responda todas as perguntas, como selecionar placas de rua, fachada de lojas, etc.",
  tseTutorial8: "Uma vez completada essa etapa clique em",
  tseTutorial9:
    "O seu título de eleitor será preenchido automaticamente em seu cadastro!",
  ...
  verify: "Verificar",
  voteAddressSubtitle:
    "De acordo com a Constituição Federal, você só pode assinar os projetos de iniciativa popular do mesmo município e estado de onde você é eleitor, ou seja, onde você vota. Agora, verifique se esses dados estão corretos.",
  voteAddressTitle: "Confirme onde você vota",
  voteCard: "Título de Eleitor",
  voteCodeConfirmed: "Seu voto foi validado com sucesso!",
  voteConfirmDismiss: "Sem essa validação seu voto não será registrado.",
  voteLocation: "Onde você vota",
  voterBirthDay: "Data de nascimento",
  voterName: "Nome do eleitor",
  voterMotherName: "Nome da mãe",
  votingCity: "Município de votação",
  votingState: "Estado de votação",
  wannaKnowMoreAboutMudamos: "Quer conhecer mais sobre o Mudamos?",
  warning: "Aviso",
  wePrepareAFormForYourHelp:
    "Preparamos um formulário especial para você tirar todas as suas dúvidas.",
  weNeedAnalyseYourProfileToSign:
    "Por segurança, precisamos analisar seus dados para ativar a assinatura.",
  willCreateNewWallet: "Vamos agora criar uma nova assinatura para você.",
  whatIsMudamos:
    "Mudamos é uma iniciativa do Instituto de Tecnologia e Sociedade do Rio (ITS Rio), premiada e financiada exclusivamente pelo prêmio Desafio Google de Impacto Social, conquistado em 2016.",
  ...
  wrongRegionThanks:
    "Obrigado por seu apoio, mas você só pode assinar esse projeto de lei sendo eleitor da região para a qual ele se destina.",
  wrongZipCode: "Não é seu CEP?",
  yes: "Sim",
  youCanSignAndShare:
    "Você já está apto a assinar e compartilhar Projetos de Lei.",
  youSignedThisProjectAt: ({ day, time }) =>
    `Você assinou este projeto em: ${day} às ${time}`,
  ...
  youWillCreateAPl:
    "Você está prestes a propor uma mudança por meio da criação de um projeto de lei de iniciativa popular!",
  zipCode: "CEP",
  zipCodeReason:
  ...
  errors: {
    ...
    passwordRetrieveError:
      "Houve um erro ao tentar enviar o código. Tente novamente.",
    saveAvatar: "Não foi possível salvar seu avatar.",
    sendVoteConfirmationError:
    ...
    walletCreationError:
      "Houve um erro ao preparar algumas informações para suas assinaturas.",
  },
  errorsCode: {
  ...
  aboutApp: {
    title:
      "Oi! Com o Mudamos, você pode assinar projetos de lei de iniciativa popular e transformar a sua cidade, estado ou o país. E tudo o que você precisa é do seu celular! :)",
    sections: [
      {
        key: "pergunta1",
      ...
      },
      {
        key: "pergunta2",
        title:
          "Por que criar um aplicativo para propor leis de iniciativa popular?",
        content:
  ...
  firstTimeOpen: {
    screen0: {
      ...
      aNewWayToMakeTheDifference:
        "Uma nova forma de participar e de fazer a diferença.",
    },
    screen1: {
      sign: "Assine!",
      signIntro:
        "Assine projetos de lei de iniciativa popular de forma rápida e segura!",
      voteCardInfoSecure:
        "É a extensão do seu título de eleitor. Suas informações são protegidas e sua assinatura garantida.",
    },
    screen2: {
      share: "Compartilhe!",
      youCanSharePls:
        "É possível compartilhar os projetos de lei com seus amigos pelas redes sociais.",
    },
  },
};
